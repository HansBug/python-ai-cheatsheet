...
目前已完成仓库基础骨架、文档规范和协作说明，并新增了 [Self-Attention / Multi-Head Attention](algos/self_attention/README.md)、[Positional Encoding / RoPE](algos/positional_encoding/README.md) 和 [LayerNorm / RMSNorm](algos/normalization/README.md) 三个专题。后续会继续补 Transformer / LLM 的高频基础模块和模型家族精读。
